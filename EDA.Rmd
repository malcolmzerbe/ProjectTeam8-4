...
=======
Is there a correlation between a player's rank and their fantasy points?
>>>>>>> 3dced674bea6d5eb2fee4714cf7b8d369e88b786
```{r}
#Scatter plot for fantasy points and rank
ggplot(AllResults, aes(x=rank, y=FPTS)) + 
  geom_point() +
  scale_x_reverse()+
  geom_smooth(method=lm)

#Scatter plot with MadeCut
ggplot(AllResults, aes(x=rank, y=FPTS, shape=MadeCut)) + 
  geom_point() + 
  scale_x_reverse()+
  geom_smooth(method=lm)
